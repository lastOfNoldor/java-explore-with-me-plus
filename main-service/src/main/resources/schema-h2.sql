...
CREATE INDEX IF NOT EXISTS idx_event_annotation ON events (annotation);
CREATE INDEX IF NOT EXISTS idx_event_description ON events (description);
...
COMMENT ON INDEX idx_event_annotation IS 'Индекс для поиска по аннотации';
COMMENT ON INDEX idx_event_description IS 'Индекс для поиска по описанию';